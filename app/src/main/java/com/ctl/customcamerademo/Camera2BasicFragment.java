...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null), "image_" + System.currentTimeMillis() + "pic.jpg");
    }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    Intent i=new Intent(getContext(), PreviewImageVideoActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.camera_flash: {
                if (flash_state==1){
                    flash_state=-1;
                    camera_flash.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_baseline_flash_off_24));
                }else {
                    flash_state++;
                    if (flash_state==0){
                        camera_flash.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_baseline_flash_auto_24));
                    }else if (flash_state==1){
                        camera_flash.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_baseline_flash_on_24));
                    }
                }
                createCameraPreviewSession();
                break;
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void startPreview(String temp_path) {
    ...
    /**
     * Update the camera preview. {@link #startPreview(String)} needs to be called in advance.
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    ...
    private void stopRecordingVideo() {
        ...
        startPreview(temp_path);
        Log.e(TAG, "stopRecordingVideo: "+temp_path);
    }
